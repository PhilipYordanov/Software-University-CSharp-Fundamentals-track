...
public class StartUp
{
        ...
        while ((input = Console.ReadLine()) != "End")
        {
            ...
            switch (args[0])
            {
                ...
                case "LeutenantGeneral":
                    var privates = ExtactPrivates(args
                        .Skip(5)
                        .ToList());
                ...
                case "Commando":
                    ...
                    var missions = ExtractMissions(args
                        .Skip(6)
                        .ToList());
    ...
    private static IList<ISoldier> ExtactPrivates(IList<string> soliders)
    {
        var list = new List<ISoldier>();

        foreach (var solider in soliders)
        {
            list.Add(army.First(s=>s.Id == solider));
        }
