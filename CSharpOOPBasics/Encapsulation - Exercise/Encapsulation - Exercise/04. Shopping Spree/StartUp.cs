    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            try
            {
                ...
                {
                    var purcahseInfo = purchase
                        .Split();

                    var buyerName = purcahseInfo[0];
                    var productName = purcahseInfo[1];

                    var buyer = people
                        .FirstOrDefault(b => b.Name == buyerName);

                    var productToBuy = products
                        .FirstOrDefault(bp => bp.Name == productName);
                    try
                    {
